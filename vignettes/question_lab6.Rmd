...
n is small, parallel execution offers no advantage compared to serial execution, and can sometimes be slower. This is because, with the brute force search method, each task is very small. When the total number of tasks is low, allocating cores and the communication between cores can increase the response time.
